    ...
    <div class="container">
        <div class="row">
            <div class="img col-md-4">
                ...
                <img style="width:100%;" name="img-main" src="{{asset('images/'.$arrImg[0])}}" class="img-fluid">
                @if(count($arrImg)>=1)
                <div class="row">
                    @if(count($arrImg)>=1)
                    <div class="col-md-4"><img onclick="action(src)" src="{{asset('images/'.$arrImg[0])}}"
                            class="img-fluid">
                    </div>
                    @endif
                    @if(count($arrImg)>=2)
                    <div class="col-md-4"><img onclick="action(src)" src="{{asset('images/'.$arrImg[1])}}"
                            class="img-fluid">
                    </div>
                    @endif
                    @if(count($arrImg)>=3)
                    <div class="col-md-4"><img onclick="action(src)" src="{{asset('images/'.$arrImg[2])}}"
                            class="img-fluid">
                    </div>
                    @endif
                </div>
